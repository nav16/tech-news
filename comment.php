...
?>
<div class="details">
<header><h3 class="headchk"><a href="<?=$rows['name']?>" class="Sg Ob Tc"><?=$rows['name']?></a></h3><span class="maui">&nbsp;-&nbsp; <span title="Time of post" ><? echo $check; ?></span><span class="comter"><?$nou = Noofurls($rows['name']);
if($nou > 30){?>
<span class="badge moderator">TC</span>
<?}?><strong><a href="comment.php?id=<? echo $rows['id'];?>"><?=$noc ?> comments</a></strong></span></header>
</div>
...
<textarea cols="75" placeholder="Give an update..." rows="2" class="xe watermark" style='max-width:505px; max-height:1000px; min-height:50px;' name="update" id="update<?=$pid;?>" maxlength="1000"></textarea>
